...
<html lang="en">
  ...
  <body class="bg-gray-50 text-gray-800 font-sans">
    <div class="max-w-5xl mx-auto py-10 px-4">
      ...
      <!-- Step 1: Select SPA -->
      <div class="mb-6">
        <label for="spaSelect" class="block text-lg font-semibold mb-2"
          >Select Target SPA</label
        >
      ...
      <!-- Step 2: Upload CSV -->
      <div class="mb-6">
        <label for="csvFile" class="block text-lg font-semibold mb-2"
      ...
      <div id="resultSection" class="mt-8">
        ...
        <div
          id="importResults"
          class="max-h-96 overflow-y-auto border rounded-xl p-4 hidden"
        ></div>
      </div>
    </div>
    ...
    <footer class="mt-10 text-center text-sm text-gray-500">
      Powered by
      <a href="https://vortexweb.cloud/" class="underline hover:text-gray-700"
        >VortexWeb</a
      >
    </footer>
